...
|------|---------|----------|--------|
| **[ai-thoughts](https://github.com/negtivspace/ai-thoughts)** | Articles & essays: AI platforms (OpenClaw, Hermes), solo entrepreneurship, privacy, technical deep-dives. Bilingual: English + Simplified/Traditional Chinese | 36 articles | `docs: update skill-publish scope to chinese-history-literature-culture` (Aug 2026) |
...
**Last Updated:** August 20, 2026 | Tracking: 6 active repos, 36 published articles, 10+ published skills
