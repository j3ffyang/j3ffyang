...
**Current Portfolio:** 23 published skills | 7 active repos | 70 technical articles | Deployed on OpenClaw, Hermes, Claude Code
...
|------|---------|----------|--------|
| **[`ai-thoughts`](https://github.com/negtivspace/ai-thoughts)** | Articles & essays: AI platforms (OpenClaw, Hermes), solo entrepreneurship, privacy, technical deep-dives. Bilingual: English + Traditional Chinese | 64 docs | `docs: add opencode-is-best essay, ollama-to-llamacpp draft, and astro-sync skill` (Aug 2026) |
...
**Resources:**
- **Blog:** [`ai-thoughts`](https://github.com/negtivspace/ai-thoughts) — 64 articles on AI, privacy, and entrepreneurship (+4 literary articles archived in [`history`](https://github.com/negtivspace/history))
...
**Last Updated:** August 11, 2026 | Tracking: 7 active repos, 70 articles, 23 published skills
